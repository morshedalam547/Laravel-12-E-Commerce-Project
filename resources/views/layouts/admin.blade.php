                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.brandAdd') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.categoryAdd') }}" class="">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('admin.contacts.show') }}" class="">
                                ...
                                <li class="menu-item">
                                    <form method="POST" action="{{ route('logout') }}" id="logout-form">
                                        ...
                                        <a href="#" class=""
                                            ...
                                            <div class="icon "><i class="fa-regular fa-circle text-danger"></i></div>
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="images/avatar/Morshed.png" alt="image">
                                                </span>
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Morshed Alam</span>
