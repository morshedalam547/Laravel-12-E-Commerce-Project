    ...
    @foreach($categories as $category)
        <div class="swiper-slide">
            <img loading="lazy" class="w-100 h-auto mb-3" 
                 src="{{ asset('/uploads/brands/' . $category->image) }}"
                 width="124" height="124" 
                 alt="{{ $category->name }}" />
            <div class="text-center">
                <a href="{{ route('admin.categories', $category->slug) }}" class="menu-link fw-medium">
                    {{ $category->name }}
                </a>
            </div>
        </div>
                    ...
                    <div class="pc__img-wrapper">
                      ...
                      <a href="details.html">
                        <img loading="lazy" src="{{asset ('/uploads/products/'. $product->image)}}" width="258" height="313"
                          alt="Cropped Faux leather Jacket" class="pc__img">
                        <img loading="lazy" src="{{asset ('/uploads/products/gallery/'. $product->image)}}" width="258" height="313"
                          alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                      </a>
                      @endforeach
                    </div>
                        ...
                        @foreach($hotDeals as $product)
                            ...
                            @php
                                ...
                                $gallery = $product->images
                                    ? (is_array($product->images) ? $product->images : explode(',', $product->images))
                                    : [];
                                $secondImage = $gallery[0] ?? null;
                            @endphp
                            ...
                            <div class="swiper-slide product-card product-card_style3">
                                ...
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('product.details', $product->slug) }}">
                                      ...
                                      @if( $secondImage)
                                            <img loading="lazy"
                                                 src="{{ asset('uploads/products/gallery/' .  $secondImage) }}"
                                                 width="258" height="313" >
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="category-banner__item border-radius-10 mb-5">
               <a href="{{ route('product.details', $product->slug) }}">
              <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/' .$product->image)}}" width="690" height="665"
                alt="" />
