                ...
                <div class="swiper-wrapper">
                  ...
                  @if(!empty($product->images))
                    @foreach(json_decode($product->images, true) as $galleryImage)
                      <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/gallery/' . $galleryImage) }}"
                          width="674" height="674" alt="" />
                        <a data-fancybox="gallery" href="{{ asset('uploads/products/' . $galleryImage) }}"
                          data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <use href="#icon_zoom" />
                          </svg>
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  @if(!empty($product->images))
                    @foreach(json_decode($product->images, true) as $galleryImage)
                      <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                          src="{{ asset('uploads/products/gallery/' . $galleryImage) }}" width="104" height="104" alt="" />
                      </div>
                ...
                <div class="pc__img-wrapper">
                  <a href="{{ route('product.details', $rproduct->slug) }}">
                    ...
                    @if(!empty($rproduct->images))
                      @foreach(json_decode($rproduct->images, true) as $galleryImage)
                        <img loading="lazy" src="{{ asset('uploads/products/gallery/' . $galleryImage) }}" width="330"
                  ...
                  @else
                    <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                      ...
                      <button type="sumbit"
                        ...
                        title="Add To Cart" data-aside="cartDrawer"> Add To Carts </button>
                    </form>
                  @endif
                </div>

                <div class="pc__info position-relative">
                  <p class="pc__category"> {{ $rproduct->category->name ?? 'No Category' }}</p>
                  <h6 class="pc__title"><a href="{{ route('product.details', $product->slug) }}">{{ $rproduct->name}}</a>
                  </h6>
