    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
               ...
               <div class="mt-3 text-left">
                                <img id="imagePreview" src="{{ $brand->image ? asset('uploads/brands/' . $brand->image) : '' }}" 
                                     alt="{{ $brand->name }}" class="img-thumbnail" style="max-width: 250px;">
                            </div>
               ...
               <div class="d-flex justify-content-left gap-3 mt-5">
                            ...
                            <button type="submit" class="btn btn-success btn-lg px-4">Update Brand</button>
                        </div>
            </form>
        </div>
    </div>
