    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            ...
            <ul class="list-group mb-4">
                <li class="list-group-item"><strong>Order No:</strong> {{ $order->order_no }}</li>
                ...
                <li class="list-group-item"><strong>VAT:</strong> ${{ number_format($order->vat, 2) }}</li>
                ...
                <li class="list-group-item"><strong>Order Date:</strong> {{ $order->created_at->format('Y-m-d H:i') }}</li>
                <li class="list-group-item"><strong>Delivered On:</strong> {{ $order->delivered_date ?? '-' }}</li>
            </ul>
...
<div class="bottom-page">
    <div class="body-text">© 2024 SurfsideMedia</div>
</div> --}}
...
<tr>
        ...
        <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="{{ $item->product ? asset('uploads/products/'.$item->product->image) : '' }}" width="50" alt="">
