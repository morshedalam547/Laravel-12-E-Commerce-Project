...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data" class="tf-section-2 form-add-product">
            @csrf
            @method('PUT')
            ...
            <div class="wg-box">
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgPreview" style="{{ $product->image ? 'display:block' : 'display:none' }}">
                            <img id="mainPreviewImg" src="{{ $product->image ? asset('uploads/products/thumbnails/'.$product->image) : '#' }}" class="effect8" alt="Preview"
                ...
                <div class="cols gap22">
                    <fieldset>
                        ...
                        <input type="number" name="regular_price" class="form-control mb-10"
                            value="{{ old('regular_price', $product->regular_price) }}" placeholder="Enter regular price" required>
                    </fieldset>
                    <fieldset>
                ...
                <div class="cols gap10 mt-4">
                    <button type="submit" class="tf-button w-full btn btn-primary">Update Products</button>
                </div>
            </div>
        </form>
    </div>
